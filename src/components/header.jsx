            ...
            <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        {/* <Button color="primary" variant="bordered" size="lg" className="mx-3">
                            Log In
                        </Button>
                    ...
                    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 left-2" id="navbar-sticky">
                        <ul class="flex flex-col justify-end m-auto p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <Link href="#" size="md" className="justify-center my-2">About us</Link>
                            <Link href="#" size="md" color="foreground" className="justify-center my-2">Features</Link>
                            <Link href="#" size="md" color="foreground" className="justify-center my-2">Blog</Link>
                            <Link href="#" size="md" color="foreground" className="justify-center my-2">Pricing</Link>
                            <Button color="primary" variant="bordered" size="lg" className="justify-center my-2">
                                Log In
                            </Button>
                            <Button color="primary" size="lg" className="justify-center my-2">
                                Get started
                            </Button>
                            {/* <li>
